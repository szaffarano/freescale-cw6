...
;** ===================================================================
TICK_1MS
            LDHX  #KEY1        ; pongo el parámetro en el stack
            PSHX
            PSHH
            ...
            LDHX  #KEY2        ; pongo el parámetro en el stack
            PSHX
            PSHH
...
S_BOUNCE1
            ...
            LSRA
            LSRA
            DBNZA END_BNC1          ; Si es cero termino el tiempo de espera, confirmo pulsacion,
            ...
            LDA   #(WAITING<<1)     ; Si no está presionada, falsa alarma
            STA   STATE,X
END_TMP2    BRA   END_SMKBD
            
TO_PUSHED   LDA   #(PUSHED<<1)      ; Paso el estado a PUSHED
            ORA   #1                ; Pongo en 1 el flag de presionado, bit 0
